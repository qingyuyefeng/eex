...
public abstract class KLineEntity implements ICandle, IMACD, IKDJ, IRSI, IVolume, IWR {
     ...
     */
    @Override
    public abstract Float getOpeningPrice();
     ...
     */
    @Override
    public abstract float getTopPrice();
     ...
     */
    @Override
    public abstract float getFloorPrice();
     ...
     */
    @Override
    public abstract Float getClosingPrice();
     ...
     */
    @Override
    public abstract float getDealQuantity();
