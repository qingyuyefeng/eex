    ...
    private void initAttrs(AttributeSet attrs, Context context) {
        ...
        if (null != array) {
            try {
                ...
                setGridLineColor(array.getColor(R.styleable.KLineChartView_gridLineColor, getColor(R.color.color_00000000)));
                //图例
...
//                setRSI3Color(array.getColor(R.styleable.KLineChartView_rsi2ColorColor, getColor(R.color.color_CB92FE)));
    ...
    @Override public void setScaleEnable(boolean scaleEnable) {
        super.setScaleEnable(scaleEnable);
    }


    @Override public void setScrollEnable(boolean scrollEnable) {
     ...
     */
    @Override public IValueFormatter getValueFormatter() {
     ...
     * @return 宽度
     */
    @Override public float getViewWidth() {
     ...
     * 获取上方padding
     */
    @Override public float getChartPaddingTop() {
     ...
     */
    @Override public Status.MainStatus getStatus() {
