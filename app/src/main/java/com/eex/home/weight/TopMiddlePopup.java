...
import com.eex.home.adapter.MoneyAdapter;
 ...
 * @ClassName: TopMiddlePopup
 * @Description: java类作用描述
 * @Author: 胡成军
 * @CreateDate: 2019/6/13 20:44
 * @UpdateUser: 更新者
 * @UpdateDate: 2019/6/13 20:44
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */
public class TopMiddlePopup extends PopupWindow {
    ...
    private ArrayList<MoneySearc> myItems;
    private int myWidth;
    ...
    public TopMiddlePopup(Context context, int width, int height, AdapterView.OnItemClickListener onItemClickListener, ArrayList<MoneySearc> items, int type) {
    ...
    private void initWidget() {
        ...
        if (myType == 1) {
            LinearLayout.LayoutParams lpPopup = (LinearLayout.LayoutParams) popupLL.getLayoutParams();
    ...
    public void show(View view) {
        if (myIsDirty) {
            ...
            adapter = new MoneyAdapter((Activity) myContext, myItems);
            if (myItems != null) {
