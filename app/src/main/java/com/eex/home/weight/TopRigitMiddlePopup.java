...
import com.eex.home.adapter.rightTitleAdapter;
 ...
 * @Version: 1.0
 */
public class TopRigitMiddlePopup  extends PopupWindow {
    private Context myContext;
    private ListView myLv;
    private AdapterView.OnItemClickListener myOnItemClickListener;
    private ArrayList<TopPopupVO> myItems;
    private int myWidth;
    ...
    private rightTitleAdapter adapter;
    public TopRigitMiddlePopup(Context context) {
        // TODO Auto-generated constructor stub
    }
    public TopRigitMiddlePopup(Context context, int width, int height, AdapterView.OnItemClickListener onItemClickListener, ArrayList<TopPopupVO> items, int type) {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_UP) {
                    if (y > height || x < left || x > right) {
                        ...
                        dismiss();
                        MoneyListActivity.img_type.setImageResource(R.drawable.shouqi);
                        MoneyListActivity.text_type.setTextColor(myContext.getResources().getColor(R.color.appbar_background3));
                    }
                }
                return true;
            }
    ...
    public void show(View view) {
        if (myIsDirty) {
            myIsDirty = false;
            adapter = new rightTitleAdapter((Activity) myContext, myItems);
