...
import com.eex.home.adapter.GuideViewPagerAdapter;
 ...
 * @ClassName: AdvertisingPageActivity
 * @Description: java类作用描述
 * @Author: 胡成军
 * @CreateDate: 2019/6/26 17:11
 * @UpdateUser: 更新者
 * @UpdateDate: 2019/6/26 17:11
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */
public class AdvertisingPageActivity  extends Activity implements View.OnClickListener {
    ...
    protected void onPause() {
        ...
        SpUtils.putBoolean(AdvertisingPageActivity.this, "first_open", true);
        finish();
