 ...
 * @ClassName: RegionAdapter
 * @Description: java类作用描述
 * @Author: 胡成军
 * @CreateDate: 2019/6/17 15:29
 * @UpdateUser: 更新者
 * @UpdateDate: 2019/6/17 15:29
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */
public class RegionAdapter extends BaseAdapter {
    ...
    private List<PhoneListBean> memactivity_uncompleted_list;

    public RegionAdapter(Activity mContext, List<PhoneListBean> memactivity_uncompleted_list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHoder.real_name_item_name.setText(memactivity_uncompleted_list.get(position).getName());
        return convertView;
    }
