 ...
 * @ClassName: SellC2CAdapter
 * @Description: java类作用描述
 * @Author: 胡成军
 * @CreateDate: 2019/8/2 13:27
 * @UpdateUser: 更新者
 * @UpdateDate: 2019/8/2 13:27
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */
public class SellC2CAdapter extends BaseQuickAdapter<Advertisingvo,BaseViewHolder> {


    public SellC2CAdapter(int layoutResId, @Nullable List<Advertisingvo> data) {
    ...
    protected void convert(BaseViewHolder helper, Advertisingvo item) {
        ...
        helper.addOnClickListener(R.id.btn_sell);
