 ...
 * @ClassName: C2CFramentProcessing
 * @Description: java类作用描述
 * @Author: 胡成军
 * @CreateDate: 2019/7/1 9:51
 * @UpdateUser: 更新者
 * @UpdateDate: 2019/7/1 9:51
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 * <p>
 * 进行中
 */
public class C2CFramentProcessing extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener, BaseQuickAdapter.RequestLoadMoreListener, BaseQuickAdapter.OnItemClickListener {
    ...
    private void setView(ArrayList<OrderDetail> lis1t) {
        adapter = new C2CMeFramentAdapter(lis1t);
        recyclerView.setAdapter(adapter);
        adapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {

                intent.putExtra("OrderId", lis1t.get(position).getId());
