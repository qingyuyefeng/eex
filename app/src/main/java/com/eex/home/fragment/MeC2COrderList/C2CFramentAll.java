 ...
 * @ClassName: C2CFramentAll
 * @Description: java类作用描述
 * @Author: 胡成军
 * @CreateDate: 2019/7/1 9:54
 * @UpdateUser: 更新者
 * @UpdateDate: 2019/7/1 9:54
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 *
 * 全部
 */
public class C2CFramentAll extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener, BaseQuickAdapter.RequestLoadMoreListener, BaseQuickAdapter.OnItemClickListener {
