...
//                requestCode, intent, FLAG);
    ...
    public void notify_mailbox(PendingIntent pendingIntent, int smallIcon, int largeIcon, ArrayList<String> messageList,
        ...
        cBuilder.setAutoCancel(true);
        // builder.setSound(Uri.parse("file:///sdcard/clickButton.mp3"));
        ...
        try {
            ...
            while ((byteread = in.read(buffer)) != -1) {
                ...
                if (progress != oldProgress) {
                    ...
                    cBuilder.setProgress(100, (int)progress, false);
                    sent();
                }
            ...
            if (e != null) {
                ...
                listener.onFailure(e,1,e.getMessage());
            } else {
                Log.e("TEST", "download apk file error:下载失败");
                listener.onFailure(e,0,"下载失败");
            }
...
*/
  ...
  /* *//**
     * 开始下载
     *//*
    private void startDownload(String mDownloadUrl,String savePath) {
        InputStream in = null;
        FileOutputStream out = null;
        try {
     ...
     * 开始下载
     */
   /* private void startDownload(String mDownloadUrl,String SAVE_FILE_NAME) {
