 ...
 * @ClassName: LatesDealFrament
 * @Description: java类作用描述
 * @Author: 胡成军
 * @CreateDate: 2019/7/8 15:39
 * @UpdateUser: 更新者
 * @UpdateDate: 2019/7/8 15:39
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 * <p>
 * 成交记录
 */
public class LatesDealFrament extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
