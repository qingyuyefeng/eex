 ...
 * 历史委托
 */
public class HistoryFrament  extends BaseFragment  implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private void net() {
        ...
        requestParam.put("delStatus", "3,4,5");
