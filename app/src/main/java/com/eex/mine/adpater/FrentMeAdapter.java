...
import com.eex.mine.activity.FrentListActivity;
 ...
 * @ClassName: FrentMeAdapter
 * @Description: java类作用描述
 * @Author: 胡成军
 * @CreateDate: 2019/7/5 11:00
 * @UpdateUser: 更新者
 * @UpdateDate: 2019/7/5 11:00
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */
public class FrentMeAdapter extends BaseAdapter {
    ...
    public FrentMeAdapter(Context context, List<Frient> frentData) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.item_frent_group, null);
            ...
            viewHoder.btn_down = (Button) convertView.findViewById(R.id.btn_down);
        ...
        viewHoder.btn_down.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.putExtra("UsName", frentData.get(position).getUserName());
                intent.setClass(context, FrentListActivity.class);
                context.startActivity(intent);
            }
        });
        return convertView;
