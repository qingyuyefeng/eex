 ...
 * @ClassName: CommMoneySeachAdapter
 * @Description: java类作用描述
 * @Author: hcj
 * @CreateDate: 2019/12/24 15:25
 * @UpdateUser: 更新者
 * @UpdateDate: 2019/12/24 15:25
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */

public class CommMoneySeachAdapter extends RecyclerAdapter<Personal> {


    public CommMoneySeachAdapter(List<Personal> data) {
        super(R.layout.re_item_tradingaccount, data);
