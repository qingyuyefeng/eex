 ...
 * @ClassName: C2CAccountDetailsActivity
 * @Description: 法币账户详情
 * @Author: hcj
 * @CreateDate: 2019/12/24 18:24
 * @UpdateUser: 更新者
 * @UpdateDate: 2019/12/24 18:24
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */

public class C2CAccountDetailsActivity extends BaseActivity
            ...
            for (int i = 0; i < ctcaccountLists.size(); i++) {
              if (coin.equals(ctcaccountLists.get(i).getCoinCode())) {
                accountDetailsEquivalent.setText(
                    data.getData().getList().get(i).getBtcabout().toString());
  ...
  @OnClick({
      ...
      R.id.account_details_financial
  })
