 ...
 * @ClassName: WithdrawalsRecordFragment
 * @Description: java类作用描述
 * @Author: hcj
 * @CreateDate: 2019/12/25 14:35
 * @UpdateUser: 更新者
 * @UpdateDate: 2019/12/25 14:35
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */

public class WithdrawalsRecordFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener, BaseQuickAdapter.OnItemClickListener {
    ...
    private void net() {
        ...
        requestParam.put("coinCode", "quanbu");
