 ...
 * @ProjectName: EEX
 * @Package: com.eex.mvp.market.fragment
 * @ClassName: FuturesMarketAdapter
 * @Description: java类作用描述
 * @Author: hcj
 * @CreateDate: 2020/1/13 19:18
 * @UpdateUser: 更新者
 * @UpdateDate: 2020/1/13 19:18
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */

public class FuturesMarketAdapter extends RecyclerAdapter<MainData> {

  public FuturesMarketAdapter(ArrayList<MainData> data) {
