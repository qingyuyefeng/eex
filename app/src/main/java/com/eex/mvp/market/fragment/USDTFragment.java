 ...
 * @ClassName: USDTFragment
 * @Description: java类作用描述
 * @Author: hcj
 * @CreateDate: 2019/12/24 9:29
 * @UpdateUser: 更新者
 * @UpdateDate: 2019/12/24 9:29
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */

public class USDTFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener,BaseQuickAdapter.OnItemClickListener {
    ...
    protected void initUiAndListener() {
        ...
        adapter = new MarketAdapter(data);
    ...
    @OnClick({R.id.market_name, R.id.market_latest_price, R.id.market_floating, R.id.market_applies})
