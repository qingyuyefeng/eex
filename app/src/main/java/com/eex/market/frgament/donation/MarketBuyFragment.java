 ...
 * @ClassName: MarketBuyFragment
 * @Description: java类作用描述
 * @Author: 胡成军
 * @CreateDate: 2019/6/19 17:04
 * @UpdateUser: 更新者
 * @UpdateDate: 2019/6/19 17:04
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 * <p>
 * 买入
 */
public class MarketBuyFragment extends BaseFragment {
  ...
  /**
   * pax buyState 为1 是限制买入
   */
  @SuppressLint("CheckResult")
  private void buyState1() {
            ...
            if (data.isStauts() == true) {
              ...
              for (int i = 0; i < data.getData().size(); i++) {
                if (data.getData().get(i).getDealPair().equals(name1)) {
                  if (data.getData().get(i).getBuyState() == 1) {
  ...
  /**
   * USDT buyState 为1 是限制买入
   */
  @SuppressLint("CheckResult")
  private void buyState2() {
  ...
  /**
   * CNYE buyState 为1 是限制买入
   */
  @SuppressLint("CheckResult")
  private void buyState3() {
  ...
  private void  getID() {
    ...
    listviewBuy1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
      ...
      public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        if (LLtype.equals("1")) {
          try {
            edtXDPrice.setText(buyList.get(position)
                .getDelAmount()
          ...
          edtZYZSPrice.setText(buyList.get(position)
              .getDelAmount()
              .setScale(4, BigDecimal.ROUND_HALF_DOWN)
              .toString());
        }
    ...
    listviewSell1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
      ...
      public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        if (LLtype.equals("1")) {
          edtXDPrice.setText(sellList.get(position)
              .getDelAmount()
              .setScale(4, BigDecimal.ROUND_HALF_DOWN)
              .toString());
        } else if (LLtype.equals("3")) {
          edtZYZSPrice.setText(sellList.get(position)
              .getDelAmount()
              .setScale(4, BigDecimal.ROUND_HALF_DOWN)
              .toString());
        }
      ...
      public void onTextChanged(CharSequence s, int start, int before, int count) {
        ...
        try {
          if (edtXDPrice.getText().toString().trim().equals("")) {
            ...
            BigDecimal NewGuzi =
                RMB.divide(USDT, 10, BigDecimal.ROUND_HALF_UP).setScale(2, BigDecimal.ROUND_DOWN);
            TXRMBPrice.setText("估值 ￥" + NewGuzi.multiply(b1)
      ...
      public void onTextChanged(CharSequence s, int start, int before, int count) {
        try {
          if (EDTZYZSCFPrice.getText().toString().trim().equals("")) {
            ...
            BigDecimal NewGuzi =
                RMB.divide(USDT, 10, BigDecimal.ROUND_HALF_UP).setScale(2, BigDecimal.ROUND_DOWN);
            TXZSZYMoneyPrice.setText("估值 ￥" + NewGuzi.multiply(b1)
                .setScale(2, BigDecimal.ROUND_DOWN)
                .stripTrailingZeros()
                .toPlainString());
          }
      ...
      public void onTextChanged(CharSequence s, int start, int before, int count) {
        try {
          if (edtZYZSPrice.getText().toString().trim().equals("")) {
            ...
            BigDecimal NewGuzi =
                RMB.divide(USDT, 10, BigDecimal.ROUND_HALF_UP).setScale(2, BigDecimal.ROUND_DOWN);
            ZSZYMoneyWTPrice.setText("估值 ￥" + NewGuzi.multiply(b1)
                .setScale(2, BigDecimal.ROUND_DOWN)
                .stripTrailingZeros()
                .toPlainString());
          }
  ...
  private void WebSocket() {
    ...
    try {
      RxWebSocket.get(WPConfig.INSTANCE.getWSUrl() + "coinsocket/" + kv.decodeString("tokenId"))
          .compose(RxSchedulers.io_main())
          .subscribe(new WebSocketSubscriber2<bIDataVO>() {
            ...
            protected void onMessage(bIDataVO bIDataVO) {
              ...
              Log.e("Buy", "onMessage: " + bIDataVO.toString());
              MoneyType = "NO";
              if (bIDataVO != null) {
                try {

                  if (bIDataVO.getCoinCode().equals(BINAME)) {
                    txUsdt.setText(bIDataVO.getCoinMoney()
                        .setScale(8, BigDecimal.ROUND_DOWN)
                        .stripTrailingZeros()
                        .toPlainString() + bIDataVO.getCoinCode() + "");
                  }
                  if (bIDataVO.getCoinCode().equals(BINAMEDATA)) {
                    Nube = bIDataVO.getCoinMoney()
                        .setScale(8, BigDecimal.ROUND_DOWN)
                        .stripTrailingZeros()
                        .toPlainString();
                    txCny.setText(bIDataVO.getCoinMoney()
                        .setScale(8, BigDecimal.ROUND_DOWN)
                        .stripTrailingZeros()
                        .toPlainString() + bIDataVO.getCoinCode() + "");
                  }
                ...
                if (data.isStauts() == true) {
                  ...
                  try {
                    ...
                    if (root.getListOrder().equals("")) {
                      ...
                      if (root.getListOrder().get(root.getListOrder().size() - 1).getDealAmount()
                          != null) {
                        newprice =
                            root.getListOrder().get(root.getListOrder().size() - 1).getDealAmount();
                        textviewPurMoney1.setText(newprice.setScale(8, BigDecimal.ROUND_DOWN)
                            .stripTrailingZeros()
                            .toPlainString());
                      }
                    }
    ...
    try {
      ...
      if (sellList != null && sellList.size() > 0) {
        for (int i = 0; i < sellList.size(); i++) {
          ...
          volume =
              sellList.get(i).getResidueNum().setScale(4, BigDecimal.ROUND_HALF_DOWN).toString();
          obj.setVolume(Float.valueOf(volume));
          obj.setPrice(Float.valueOf(price));
          obj1.setVolume(Float.valueOf(volume));
          obj1.setPrice(Float.valueOf(price));
    ...
    try {
      ...
      if (root.getListOrder().equals("")) {
        ...
        if (root.getListOrder().get(root.getListOrder().size() - 1).getDealAmount() != null) {
          ...
          textviewPurMoney1.setText(
              newprice.setScale(8, BigDecimal.ROUND_DOWN).stripTrailingZeros().toPlainString());
        }
      }
    } catch (Exception e) {
    }
  ...
  protected int getLayoutId() {
    return R.layout.fragment_market_buy;
  }
  ...
  @SuppressLint("SetTextI18n")
  @OnClick({
      R.id.tx_Namexianjia, R.id.tx_Nameshijia, R.id.tx_NameZhiyin, R.id.tx_premium,
      R.id.LL_Fixed_price, R.id.XJPriceBtnSub, R.id.edt_XDPrice,
      R.id.XJPriceBtnAdd, R.id.TXRMBPrice, R.id.XJNuberBtnSub, R.id.edt_XDnuber, R.id.XJNuberBtnAdd,
      R.id.btnXD1, R.id.btnXD2, R.id.btnXD3,
      R.id.btnXD4, R.id.edt_XJMoney, R.id.LLMoney, R.id.LLXJD, R.id.LLSJ, R.id.SJNuberBtnSub,
      R.id.edt_SJnuber, R.id.SJNuberBtnAdd, R.id.SJBtn1,
      R.id.SJBtn2, R.id.SJBtn3, R.id.SJBtn4, R.id.LLSJD, R.id.ZYZSCfBtnPriceSub,
      R.id.EDT_ZYZSCFPrice, R.id.ZYZSCfBtnPriceAdd, R.id.TXZSZYMoneyPrice,
      R.id.ZYZSWtBtnPriceSub, R.id.edt_ZYZSPrice, R.id.ZYZSWtBtnPriceAdd, R.id.ZSZYMoneyWTPrice,
      R.id.ZYZSWtBtnNuberSub, R.id.edt_ZYZSnuber,
      R.id.ZYZSWtBtnNuberAdd, R.id.ZYZSBtn1, R.id.ZYZSBtn2, R.id.ZYZSBtn3, R.id.ZYZSBtn4,
      R.id.LLZYZSD, R.id.tx_usdt, R.id.tx_cny, R.id.btn_buy,
      R.id.TypeText, R.id.LLbuysell, R.id.textviewPurMoney1, R.id.textviewPurMoney2, R.id.tx_type,
      R.id.MoneyWater, R.id.img_type, R.id.rlgone,
      R.id.ll_title, R.id.LLList, R.id.LLYJD_premium, R.id.LLYJpremium, R.id.edt_YJNnuber,
      R.id.YJNBtn1, R.id.YJNBtn2, R.id.YJNBtn3, R.id.YJNBtn4
  })
  public void onViewClicked(View view) {
    switch (view.getId()) {
      ...
      case R.id.tx_Namexianjia:
        ...
        edtYJNnuber.setText("");
        txNamexianjia.setTextColor(
            getActivity().getResources().getColor(R.color.appbar_background3));
      ...
      case R.id.XJPriceBtnSub:
        if (!edtXDPrice.getText().toString().trim().equals("")) {
          if (new BigDecimal(edtXDPrice.getText().toString().trim()).compareTo(BigDecimal.ZERO)
              == 0) {
      ...
      case R.id.XJPriceBtnAdd:
        if (!edtXDPrice.getText().toString().trim().equals("")) {
          BigDecimal price = new BigDecimal(edtXDPrice.getText().toString().trim());
          BigDecimal subPrice = price.add(new BigDecimal(XJPriceSubMethod(edtXDPrice.getText().toString().trim())));
          edtXDPrice.setText(subPrice.setScale(pricNuber.intValue(), BigDecimal.ROUND_DOWN).stripTrailingZeros().toPlainString());
        } else {
          edtXDPrice.setText("1");
        }
      ...
      case R.id.XJNuberBtnSub:
        if (!edtXDnuber.getText().toString().trim().equals("")) {
          if (new BigDecimal(edtXDnuber.getText().toString().trim()).compareTo(BigDecimal.ZERO)
              == 0) {
          ...
          if (new BigDecimal(edtXDnuber.getText().toString().trim()).compareTo(BigDecimal.ZERO)
            ...
            BigDecimal subPrice = price.subtract(
                new BigDecimal(XJPriceSubMethod(edtXDnuber.getText().toString().trim())));
            edtXDnuber.setText(subPrice.setScale(quantityNuber.intValue(), BigDecimal.ROUND_DOWN)
                .stripTrailingZeros()
                .toPlainString());
          }
        }
      ...
      case R.id.XJNuberBtnAdd:
        if (!edtXDnuber.getText().toString().trim().equals("")) {
          BigDecimal price = new BigDecimal(edtXDnuber.getText().toString().trim());
          BigDecimal subPrice =
              price.add(new BigDecimal(XJPriceSubMethod(edtXDnuber.getText().toString().trim())));
          edtXDnuber.setText(subPrice.setScale(quantityNuber.intValue(), BigDecimal.ROUND_DOWN)
              .stripTrailingZeros()
              .toPlainString());
        } else {
      ...
      case R.id.btnXD1:
        if (kv.decodeString("tokenId") != null) {
          ...
          if (edtXDPrice.getText().toString().trim() != null && !edtXDPrice.getText()
              .toString()
              .trim()
              .equals("")) {
            try {
              BigDecimal NuberType = new BigDecimal(Nube).divide(
                  new BigDecimal(edtXDPrice.getText().toString().trim()), 10,
                  BigDecimal.ROUND_HALF_UP);
              BigDecimal newNuber = NuberType.multiply(new BigDecimal("0.25"));
              edtXDnuber.setText(newNuber.setScale(quantityNuber.intValue(), BigDecimal.ROUND_DOWN)
                  .stripTrailingZeros()
                  .toPlainString());
            } catch (Exception e) {
        ...
        if (kv.decodeString("tokenId") != null) {
          ...
          if (edtXDPrice.getText().toString().trim() != null && !edtXDPrice.getText()
            ...
            try {
              ...
              edtXDnuber.setText(newNuber1.setScale(quantityNuber.intValue(), BigDecimal.ROUND_DOWN)
                  .stripTrailingZeros()
                  .toPlainString());
            } catch (Exception e) {
        ...
        if (kv.decodeString("tokenId") != null) {
          ...
          if (edtXDPrice.getText().toString().trim() != null && !edtXDPrice.getText()
            ...
            try {
              ...
              edtXDnuber.setText(newNuber2.setScale(quantityNuber.intValue(), BigDecimal.ROUND_DOWN)
                  .stripTrailingZeros()
                  .toPlainString());
            } catch (Exception e) {
        ...
        if (kv.decodeString("tokenId") != null) {
          ...
          if (edtXDPrice.getText().toString().trim() != null && !edtXDPrice.getText()
            ...
            try {
              ...
              edtXDnuber.setText(newNuber3.setScale(quantityNuber.intValue(), BigDecimal.ROUND_DOWN)
                  .stripTrailingZeros()
                  .toPlainString());
            } catch (Exception e) {
      ...
      case R.id.SJNuberBtnAdd:
        if (!edtSJnuber.getText().toString().trim().equals("")) {
          ...
          BigDecimal subPrice =
              price.add(new BigDecimal(XJPriceSubMethod(edtSJnuber.getText().toString().trim())));
          edtSJnuber.setText(subPrice.setScale(quantityNuber.intValue(), BigDecimal.ROUND_DOWN)
              .stripTrailingZeros()
              .toPlainString());
        } else {
      ...
      case R.id.SJBtn1:
        if (kv.decodeString("tokenId") != null) {
          ...
          if (newprice != null && newprice.compareTo(BigDecimal.ZERO) == 1) {
            BigDecimal NuberType =
                new BigDecimal(Nube).divide(newprice, 10, BigDecimal.ROUND_HALF_UP);
            BigDecimal newNuber3 = NuberType.multiply(new BigDecimal("0.25"));
            edtSJnuber.setText(newNuber3.setScale(quantityNuber.intValue(), BigDecimal.ROUND_DOWN)
                .stripTrailingZeros()
                .toPlainString());
          } else {
      ...
      case R.id.SJBtn2:
        if (kv.decodeString("tokenId") != null) {
          ...
          if (newprice != null && newprice.compareTo(BigDecimal.ZERO) == 1) {
            BigDecimal NuberType =
                new BigDecimal(Nube).divide(newprice, 10, BigDecimal.ROUND_HALF_UP);
            BigDecimal newNuber3 = NuberType.multiply(new BigDecimal("0.50"));
            edtSJnuber.setText(newNuber3.setScale(quantityNuber.intValue(), BigDecimal.ROUND_DOWN)
                .stripTrailingZeros()
                .toPlainString());
          } else {
      ...
      case R.id.SJBtn4:
        ...
        Log.e(TAG, "onViewClicked: " + "市价单  100%");
        if (kv.decodeString("tokenId") != null) {
          SJBtn1.setBackgroundResource(R.drawable.btn_grd);
          SJBtn2.setBackgroundResource(R.drawable.btn_grd);
          SJBtn3.setBackgroundResource(R.drawable.btn_grd);
      ...
      case R.id.ZYZSCfBtnPriceSub:
        ...
        if (!EDTZYZSCFPrice.getText().toString().trim().equals("")) {
          if (new BigDecimal(EDTZYZSCFPrice.getText().toString().trim()).compareTo(BigDecimal.ZERO)
              == 0) {
          ...
          if (new BigDecimal(EDTZYZSCFPrice.getText().toString().trim()).compareTo(BigDecimal.ZERO)
            ...
            BigDecimal subPrice = price.subtract(
                new BigDecimal(XJPriceSubMethod(EDTZYZSCFPrice.getText().toString().trim())));
            EDTZYZSCFPrice.setText(subPrice.setScale(pricNuber.intValue(), BigDecimal.ROUND_DOWN)
                .stripTrailingZeros()
                .toPlainString());
          }
        }
      ...
      case R.id.ZYZSWtBtnPriceSub:
        if (!edtZYZSPrice.getText().toString().trim().equals("")) {
          if (new BigDecimal(edtZYZSPrice.getText().toString().trim()).compareTo(BigDecimal.ZERO)
              == 0) {
          ...
          if (new BigDecimal(edtZYZSPrice.getText().toString().trim()).compareTo(BigDecimal.ZERO)
            ...
            BigDecimal subPrice = price.subtract(
                new BigDecimal(XJPriceSubMethod(edtZYZSPrice.getText().toString().trim())));
            edtZYZSPrice.setText(subPrice.setScale(pricNuber.intValue(), BigDecimal.ROUND_DOWN)
                .stripTrailingZeros()
                .toPlainString());
          }
        }
      ...
      case R.id.ZYZSWtBtnNuberAdd:
        if (!edtZYZSnuber.getText().toString().trim().equals("")) {
          ...
          BigDecimal subPrice =
              price.add(new BigDecimal(XJPriceSubMethod(edtZYZSnuber.getText().toString().trim())));
          edtZYZSnuber.setText(subPrice.setScale(quantityNuber.intValue(), BigDecimal.ROUND_DOWN)
              .stripTrailingZeros()
              .toPlainString());
        } else {
      ...
      case R.id.YJNBtn1:
        if (kv.decodeString("tokenId") != null) {
          ...
          try {
            ...
            edtYJNnuber.setText(newNuber4.setScale(quantityNuber.intValue(), BigDecimal.ROUND_DOWN)
                .stripTrailingZeros()
                .toPlainString());
          } catch (Exception e) {
        ...
        if (kv.decodeString("tokenId") != null) {
          ...
          if (newprice != null && newprice.compareTo(BigDecimal.ZERO) == 1) {
            try {
              ...
              edtYJNnuber.setText(
                  newNuber4.setScale(quantityNuber.intValue(), BigDecimal.ROUND_DOWN)
                      .stripTrailingZeros()
                      .toPlainString());
            } catch (Exception e) {
      ...
      case R.id.btn_buy:
        if (kv.decodeString("tokenId") != null) {
          ...
          if (LLtype.equals("1")) {
            ...
            if (datalIsts.get(0)
                .getDealPrice()
                .compareTo(new BigDecimal(EDTZYZSCFPrice.getText().toString().trim())) == 1) {
              mMyDialog = new MyDialog(getActivity(), 0, 0, view1, R.style.DialogTheme);
              mMyDialog.setCancelable(true);
              Tltle.setText("当最新价格小于或等于"
                  + EDTZYZSCFPrice.getText().toString().trim()
                  + BINAMEDATA
                  + "时,那么将会以"
                  + edtZYZSPrice.getText().toString().trim()
                  + BINAMEDATA
                  + "买入"
                  + edtZYZSnuber.getText().toString().trim()
                  + BINAME);
              mMyDialog.show();
            ...
            } else if (datalIsts.get(0)
                .getDealPrice()
                .compareTo(new BigDecimal(EDTZYZSCFPrice.getText().toString().trim())) == -1) {
              mMyDialog = new MyDialog(getActivity(), 0, 0, view1, R.style.DialogTheme);
              mMyDialog.setCancelable(true);
              Tltle.setText("当最新价格大于或等于"
                  + EDTZYZSCFPrice.getText().toString().trim()
                  + BINAMEDATA
                  + "时,那么将会以"
                  + edtZYZSPrice.getText().toString().trim()
    ...
    try {
      ...
      if (LLtype.equals("2")) {
        ...
        if (new BigDecimal(edtSJnuber.getText().toString().trim()).compareTo(MIN) == -1) {
          Toast.makeText(getActivity(), "最小委托数量不能低于" + MIN.stripTrailingZeros().toPlainString(),
              Toast.LENGTH_SHORT).show();
          return;
        }
        if (new BigDecimal(edtSJnuber.getText().toString().trim()).compareTo(MAX) == 1) {
          Toast.makeText(getActivity(), "最大委托数量不能大于" + MAX.stripTrailingZeros().toPlainString(),
              Toast.LENGTH_SHORT).show();
          return;
        }
      ...
      //Log.e("BUY1", BINAME + "----" + BINAMEDATA + "---" + edt_Price.getText().toString().trim() + "-----" + edt_nuber.getText().toString().trim());
      //交易币
  ...
  private void StopLoss() {
    ...
    try {
      ...
      hashMap.put("triggerPrice",
          tri.setScale(pricNuber.intValue(), BigDecimal.ROUND_HALF_UP).toString());
                    ...
                    if (root.getData().getBuy() != null || root.getData().getSell() != null) {
                      ...
                      try {
                        ...
                        if (root.getData().getListOrder().equals("")) {
                          ...
                          if (root.getData()
                              .getListOrder()
                              .get(root.getData().getListOrder().size() - 1)
                              .getDealAmount() != null) {
                            newprice = root.getData()
                                .getListOrder()
                                .get(root.getData().getListOrder().size() - 1)
                                .getDealAmount();
                            textviewPurMoney1.setText(newprice.setScale(8, BigDecimal.ROUND_DOWN)
                      ...
                      if (root.getData().getSell() != null
                          && root.getData().getSell().size() != 0) {
                      ...
                      try {
                        if (root.getData().getListOrder() != null
                            && root.getData().getListOrder().size() != 0) {
        ...
        .subscribe(data -> {
          try {
            if (data.isStauts() == true) {
              ...
              //限制Edt输入位数
              edtXDPrice.setFilters(
                  new InputFilter[] { new DecimalDigitsInputFilter(pricNuber.intValue()) });
              edtXDnuber.setFilters(
                  new InputFilter[] { new DecimalDigitsInputFilter(quantityNuber.intValue()) });
              edtXJMoney.setFilters(
                  new InputFilter[] { new DecimalDigitsInputFilter(pricNuber.intValue()) });

              edtSJnuber.setFilters(
                  new InputFilter[] { new DecimalDigitsInputFilter(quantityNuber.intValue()) });

              EDTZYZSCFPrice.setFilters(
                  new InputFilter[] { new DecimalDigitsInputFilter(pricNuber.intValue()) });
              edtZYZSPrice.setFilters(
                  new InputFilter[] { new DecimalDigitsInputFilter(pricNuber.intValue()) });
              edtZYZSnuber.setFilters(
                  new InputFilter[] { new DecimalDigitsInputFilter(quantityNuber.intValue()) });
            } else {
              t(data.getMsg());
            }
    ...
    ApiFactory.getInstance()
        ...
        .subscribe(arrayListData -> {
          ...
          if (arrayListData.getData() != null) {
            ...
            try {
              textviewPurMoney2.setText("¥" + arrayListData.getData()
                  .get(0)
                  .getUsdtCny()
  ...
  private void getMoney() {
    ...
    ApiFactory.getInstance()
        ...
        .subscribe(arrayListData -> {
          ...
          if (arrayListData.getCode() == 10002 || arrayListData.getCode() == 10001) {
            Toast.makeText(getActivity(), "登陆超时请重新登陆", Toast.LENGTH_SHORT).show();
          }

          if (arrayListData.getData() != null) {
            try {
              ktYong = arrayListData.getData()
                  .get(0)
                  .getData()
                  .getCoinMoney()
                  .setScale(8, BigDecimal.ROUND_DOWN)
                  ...
                  .toPlainString()
                  .toString();
              txUsdt.setText(arrayListData.getData()
                  .get(0)
                  .getData()
                  .getCoinMoney()
                  .setScale(8, BigDecimal.ROUND_DOWN)
              ...
              if (BINAMEDATA.equals("CNYE")) {
                Nube = arrayListData.getData()
                    ...
                    .stripTrailingZeros()
                    .toPlainString();
                txCny.setText(arrayListData.getData()
                    .get(1)
                    .getData()
                    .getUsableCNY()
                    .setScale(8, BigDecimal.ROUND_DOWN)
  ...
  public void onStop() {
    ...
    Disposable disposable1 =
        RxWebSocket.get(WPConfig.INSTANCE.getWSUrl() + "websocket/" + name1).subscribe();
