 ...
 * @ClassName: USDTSummaryFragment
 * @Description: java类作用描述
 * @Author: 胡成军
 * @CreateDate: 2019/6/20 10:46
 * @UpdateUser: 更新者
 * @UpdateDate: 2019/6/20 10:46
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 * <p>
 * <p>
 * USDT
 */
public class USDTFragment extends BaseFragment implements BaseQuickAdapter.OnItemClickListener, SwipeRefreshLayout.OnRefreshListener {
