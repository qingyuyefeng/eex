 ...
 * @Package: com.overthrow.market.frgament.market
 * @ClassName: InnovationSectionFragment
 * @Description: java类作用描述
 * @Author: 胡成军
 * @CreateDate: 2019/10/11 9:33
 * @UpdateUser: 更新者
 * @UpdateDate: 2019/10/11 9:33
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */
public class InnovationSectionFragment extends BaseFragment implements BaseQuickAdapter.OnItemClickListener, SwipeRefreshLayout.OnRefreshListener {

    private static final String TAG = "USDTFragment";
    /**
     *
     */
    ...
    private static final ArrayList<MainData> data = new ArrayList<>();
    ...
    //button状态
    private String ButtonType = "USDT";
