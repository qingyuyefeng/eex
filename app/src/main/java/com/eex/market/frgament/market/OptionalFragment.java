 ...
 * @Author: 胡成军
 * @CreateDate: 2019/6/20 10:36
 * @UpdateUser: 更新者
 * @UpdateDate: 2019/6/20 10:36
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 * <p>
 * 自选
 */
public class OptionalFragment extends BaseFragment implements BaseQuickAdapter.OnItemClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private void getDealPairCollectionList() {
