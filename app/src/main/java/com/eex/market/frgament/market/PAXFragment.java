 ...
 * @ClassName: PAXFragment
 * @Description: java类作用描述
 * @Author: 胡成军
 * @CreateDate: 2019/6/20 10:45
 * @UpdateUser: 更新者
 * @UpdateDate: 2019/6/20 10:45
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 * <p>
 * PAX
 */
public class PAXFragment extends BaseFragment implements BaseQuickAdapter.OnItemClickListener, SwipeRefreshLayout.OnRefreshListener {
