...
class DealOpBuyStateMapper(private val pairName:String):Function<Data<ArrayList<MainList>>,Spot> {
  override fun apply(dto: Data<ArrayList<MainList>>) = Spot(
      isBuyOrSellValid = dto.data.none { it.dealPair== pairName && it.buyState == 1}
  )
}