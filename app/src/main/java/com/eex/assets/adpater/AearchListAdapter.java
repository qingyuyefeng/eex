 ...
 * @ClassName: AearchListAdapter
 * @Description: java类作用描述
 * @Author: 胡成军
 * @CreateDate: 2019/7/2 16:55
 * @UpdateUser: 更新者
 * @UpdateDate: 2019/7/2 16:55
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */
public class AearchListAdapter extends BaseQuickAdapter<Bilistdata, BaseViewHolder> {


    private FinalBitmap fb;

    public AearchListAdapter(int layoutResId, @Nullable List<Bilistdata> data) {
    ...
    protected void convert(BaseViewHolder helper, Bilistdata item) {
        ...
        fb.display(imageView,WPConfig.INSTANCE + item.getImgUrl() + "");
